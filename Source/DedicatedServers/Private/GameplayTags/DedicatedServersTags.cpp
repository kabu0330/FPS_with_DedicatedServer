...
namespace DedicatedServersTags
{
	...
	namespace GameStatsAPI
	{
		...
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(UpdateLeaderboard, "DedicatedServersTags.GameStatsAPI.UpdateLeaderboard", "update the leaderboard in GameStats API")
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(RetrieveLeaderboard, "DedicatedServersTags.GameStatsAPI.RetrieveLeaderboard", "update the leaderboard in GameStats API")
